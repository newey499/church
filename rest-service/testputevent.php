...
function ajaxCall()
{
	...
	$.ajax({
		 type: "POST",
		 url: "http://rest-church/events/forthcoming",
		 processData: false,
...
<p>
Test harness for updating a forthcoming event
</p>

<p>
Submit form to "http://<?php print($_SERVER['SERVER_NAME']); ?>/events/forthcoming"
</p>


<!-- <form name="forthcoming" action="despatcher.php" method="post"> -->
<!-- <form name="forthcoming" action="http://rest-church/events/forthcoming" method="put"> -->
