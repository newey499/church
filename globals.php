...
// Opcode for defining an MP3 file upload for Sermons and Talks
define("ST_UPLOAD_MP3_FILE", 100);
// Opcode for updating the lastupdated timestamp of a sermons and talks row
define("ST_TOUCH", 101);
