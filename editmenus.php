...
function buildFormObject() {
	...
	if	($_GET['opcode'] == VALIDATE_WRITE_REC) {
		...
		$obj->addLink("bmenus.php","Menu Entries");	// Add a link to take us back to the Home page		
		...
		if (validate($_GET['subcode'])){
			if (doSQL($dbHandle, $_GET['subcode'])) {
				...
				***************************/
				...
				buildMenuItem("bmenus.php","Menu Entries");	// Add a link to take us back to the Home page		
			}			
		}
		else {
