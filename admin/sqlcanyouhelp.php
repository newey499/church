<?php
	...
	switch ($_POST['opcode']) {
		case INSERT_REC:
			$pageTitle="Insert a new Can You Help entry";
			break;
		case UPDATE_REC:
			$pageTitle="Update this existing Can You Help entry";
			break;
		case DELETE_REC:
			$pageTitle="Delete this Can You Help Entry";
			break;
		default:
...
function doSQL($mysqli) {
	...
	switch ($_POST['opcode']) {
		case INSERT_REC:
			$stmnt = sprintf("INSERT INTO canyouhelp
		...
		case UPDATE_REC:
			$stmnt = sprintf("UPDATE canyouhelp
		...
		case DELETE_REC:
			$stmnt = sprintf("DELETE FROM canyouhelp
											 WHERE id=%d",
											 $_POST['id']
											);
...
<?php
	...
	if (validate()){
		...
		print("<p>Return to Can You Help entries <a href=\"editcanyouhelpevents.php?$args\">Edit Page</a></p>\n");
	}


	print("<p>Return to <a href=\"bcanyouhelp.php?$args\">Can You Help Entries</a>" .
